...
public class BeatBox {
    ...
    public void buildGUI() {
        ...
        clearBeat.addActionListener(new ClearBeatListener());
        ...
        /*  changed to a file menu load operation
    ...
    private static class CloseMenuListener implements ActionListener {
        public void actionPerformed(ActionEvent a){
            System.exit(0);
        }
    }

    public class ClearBeatListener implements ActionListener {
        public void actionPerformed(ActionEvent a){
            loadedFileBool = false;
            for(int i = 0; i < 256; i++){
    ...
    public class MySendListener implements ActionListener{
        public void actionPerformed(ActionEvent a){
            ...
            if(loadedFileBool && loadedFile.exists() && loadedFile.isFile()){
                try{
                    FileOutputStream fileStream = new FileOutputStream(loadedFile);
...
*/
    ...
    public class OpenMenuListener implements ActionListener{
        public void actionPerformed(ActionEvent a){
            ...
            loadedFile = fileOpen.getSelectedFile();
            loadedFileBool = true;
            try{
